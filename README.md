...
| # | Topic | Description |
|---|-------|-------------|
| 1 | [Python Basics](./1_Python_Basics/) | Variables, data types, control flow, functions, and OOP |
| 2 | [NumPy](./2_NumPy/) | Arrays, broadcasting, linear algebra, and numerical computing |
| 3 | [Pandas](./3_Pandas/) | DataFrames, data cleaning, merging, grouping, and aggregation |
